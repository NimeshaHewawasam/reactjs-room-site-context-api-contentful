...
export default [
  {
    ...
    fields: {
      ...
      featured: false,
      description:
        "We have economy rooms available for solo travelers or those wishing to have their own privacy. These are comfortable with a smaller double bed and have their own en suites. (One room has a single bed though!) All have plenty of light and windows and are nicely furnished. As a single person you will be very comfortable!.",
      extras: [
  ...
  },
  {
    ...
    fields: {
      ...
      featured: false,
      description:
        "Our Family suites have a separate entry sitting room opening to a bedroom with queen size bed and a divan. The family suite has a large shower room. It is ideal for people who want a large room and who do not wish to use stairs. Also for people with children it is ideal. It can sleep up to 4 persons so is great for a family.",
      extras: [
        "Plush pillows and breathable bed linens",
        "Soft, oversized bath towels",
        "Full-sized, pH-balanced toiletries",
